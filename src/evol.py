...
#? Faire le split manuellement afin de pouvoir controller le volument de données d'entrainements et le bruit ?
...
for split_data in train_data:
    ...
    f1_scores.append(metrics.f1_score(y_test,nb.predict_bayes_all(FEAT_test)))
