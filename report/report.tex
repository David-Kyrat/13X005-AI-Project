...
sample \(x_i\) et \(w, b\) le vecteur de poids et biais.\\
...
les \(w\) et \(b\) qui respectent les critères mentionnés ci-dessus en
calculant le gradient de la fonction de coût à chaque itérations et en
allant dans la direction opposé.
...
Soit
\(\nabla C(w,b) = (\frac{\partial C(w,b)}{\partial w}, \frac{\partial C(w,b)}{\partial b} )\),
pour un sample \(x_i\) et sa classe \(y_i\), on obtient: \begin{align*}
